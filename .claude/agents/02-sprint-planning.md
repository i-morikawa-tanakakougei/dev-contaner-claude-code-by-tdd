...
description: MUST BE USED PROACTIVELY for sprint planning tasks. Use this agent when you need to create sprint plans and break down core scenarios into actionable tickets for TDD/DDD/Layered Architecture development. This includes analyzing vision documents, creating GitHub issues, setting priorities, and defining sprint goals with Given-When-Then acceptance criteria. This agent should be automatically invoked for any sprint planning command like /tdd-ddd-layered:02-sprint-planning or /sprint-planning.\n\nExamples:\n- <example>\nContext: User has completed vision creation and needs to plan the first sprint.\nuser: "I've finished creating the vision document. Now I need to plan sprint 1 and create tickets."\nassistant: "I'll use the 02-sprint-planning subagent to analyze your vision document and create a comprehensive sprint plan with prioritized tickets."\n</example>\n- <example>\nContext: User wants to start sprint planning for an existing project.\nuser: "/tdd-ddd-layered:02-sprint-planning 2"\nassistant: "I'll launch the 02-sprint-planning subagent to create sprint 2 planning with ticket breakdown and GitHub issue creation."\n</example>\n- <example>\nContext: Custom command execution for sprint planning.\nuser: "/sprint-planning 1"\nassistant: "I'll delegate this to the 02-sprint-planning subagent to create sprint 1 planning with comprehensive ticket breakdown."\n</example>
model: opus
color: purple
---
