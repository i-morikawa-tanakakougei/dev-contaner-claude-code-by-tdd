...
As a fallback mechanism in case the specialized subagent 02-sprint-planning is not properly invoked:
- MUST READ: /workspace/.claude/agents/02-sprint-planning.md
...
## Task Execution
[Execute 02-sprint-planning specific tasks]
