...
As a fallback mechanism in case the specialized subagent 10-run-all-tests is not properly invoked:
- MUST READ: /workspace/.claude/agents/10-run-all-tests.md
...
## Task Execution
[Execute 10-run-all-tests specific tasks]
