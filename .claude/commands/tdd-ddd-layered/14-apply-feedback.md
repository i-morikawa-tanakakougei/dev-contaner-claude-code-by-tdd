...
As a fallback mechanism in case the specialized subagent 14-apply-feedback is not properly invoked:
- MUST READ: /workspace/.claude/agents/14-apply-feedback.md
...
## Task Execution
[Execute 14-apply-feedback specific tasks]
