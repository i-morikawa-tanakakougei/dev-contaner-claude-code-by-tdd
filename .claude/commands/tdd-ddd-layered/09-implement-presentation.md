...
As a fallback mechanism in case the specialized subagent 09-implement-presentation is not properly invoked:
- MUST READ: /workspace/.claude/agents/09-implement-presentation.md
...
## Task Execution
[Execute 09-implement-presentation specific tasks]
