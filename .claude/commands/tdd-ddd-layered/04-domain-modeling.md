...
As a fallback mechanism in case the specialized subagent 04-domain-modeling is not properly invoked:
- MUST READ: /workspace/.claude/agents/04-domain-modeling.md
...
## Task Execution
[Execute 04-domain-modeling specific tasks]
