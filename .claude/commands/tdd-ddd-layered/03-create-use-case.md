...
As a fallback mechanism in case the specialized subagent 03-create-use-case is not properly invoked:
- MUST READ: /workspace/.claude/agents/03-create-use-case.md
...
## Task Execution
[Execute 03-create-use-case specific tasks]
