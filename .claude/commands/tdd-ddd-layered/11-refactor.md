...
As a fallback mechanism in case the specialized subagent 11-refactor is not properly invoked:
- MUST READ: /workspace/.claude/agents/11-refactor.md
...
## Task Execution
[Execute 11-refactor specific tasks]
