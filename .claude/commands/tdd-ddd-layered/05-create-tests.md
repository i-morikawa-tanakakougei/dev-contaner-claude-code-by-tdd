...
As a fallback mechanism in case the specialized subagent 05-create-tests is not properly invoked:
- MUST READ: /workspace/.claude/agents/05-create-tests.md
...
## Task Execution
[Execute 05-create-tests specific tasks]
