...
As a fallback mechanism in case the specialized subagent 07-implement-usecase is not properly invoked:
- MUST READ: /workspace/.claude/agents/07-implement-usecase.md
...
## Task Execution
[Execute 07-implement-usecase specific tasks]
